# Graph Report - chore-graphify-bootstrap  (2026-05-20)
...
## Summary
- 208 nodes · 236 edges · 17 communities (10 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0899a213`
...
1. `StaticAppScaffoldTests` - 14 edges
2. `read_text()` - 13 edges
3. `Known Issues and Limitations` - 10 edges
4. `Handoff: research-to-project-lab` - 10 edges
5. `Scoring Rubric Reference` - 10 edges
6. `Research-to-Project Lab` - 9 edges
7. `User Guide: From Research Source to Experiment Candidate` - 9 edges
8. `한국어 사용자 가이드: 연구 소스에서 실험 후보까지` - 8 edges
9. `SourceRecordModelTests` - 7 edges
10. `main()` - 7 edges
...
Cohesion: 0.06
Nodes (42): actionButtons(), allCandidates, allowedSourceTypes, candidateEmptyStates, candidateErrorCopy, candidatesToMarkdown(), confidenceScore(), copyMarkdown() (+34 more)
...
## Knowledge Gaps
- **90 isolated node(s):** `rubricLabels`, `rubricDescriptions`, `allowedSourceTypes`, `loadedCandidates`, `allCandidates` (+85 more)
...
- **What connects `rubricLabels`, `rubricDescriptions`, `allowedSourceTypes` to the rest of the system?**
